...
const Work = () => {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      <div className="flex flex-col items-center xl:flex-row container mx-auto ">
        <div className="text-center flex flex-col justify-center  xl:text-left h-full">
          ...
          <motion.p
            ...
            animate="show"
            exit="hidden"
            className="max-w-sm xl:max-w-[420px] mx-auto xl:mx-0 mb-10 xl:mb-16"
          >
        ...
        <motion.div
          ...
          animate="show"
          exit="hidden"
          className="w-full lg:max-w-[55%] lg:ml-10"
        >
          <WorkSlider />
        </motion.div>
      </div>
